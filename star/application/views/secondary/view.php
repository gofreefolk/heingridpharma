 ...
 <script src="<?php echo base_url()."assets/"?>js/interface.js"></script>
  <script src="<?php echo base_url()."assets/"?>js/jquery.js"></script>
                ...
                <div class="col-lg-12" align="center">
                    <h1 class="page-header">Select your operation</h1>
                </div>
  ...
  <div class="dock-container" >
	  <a class="dock-item" href="<?php echo base_url(); ?>index.php/secondary/add_product">
	  ...
	  <a class="dock-item" href="<?php echo base_url(); ?>index.php/secondary/view_secondary_by_year">
	  
	  	<?php 
	  	
     $myimg = array(
     				'src'=>'assets/images/dock/daily_report.png',
     				'alt'=>"Secondary Report"
					);
      echo img($myimg); ?>
	  	<span>Secondary Report</span></a> 
