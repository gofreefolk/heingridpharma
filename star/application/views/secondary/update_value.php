 ...
 ?>
  ...
  <div class="modal-dialog" style="width: 700px">
    <div class="modal-content">
      ...
      <?php echo form_open("secondary/save_update_value"); ?>
      <div class="modal-body">
        
          
          <div class="form-group">
            <label for="product" class="control-label">VALUE</label>
       ...
       <input type="hidden" value="<?php echo $value_id; ?>" name="value_id" id="value_id"/>
