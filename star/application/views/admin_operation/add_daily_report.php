...
<div id="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    $attributes = array('id' => 'myform');
                                     echo form_open('admin_staff_operation/insert_daily', $attributes); ?>
                                    
                                    	 <div class="form-group">
                                            <label for="date">Date</label>
                                            <input class="form-control" placeholder="Select the date" required=""  name="date" id="date" type="date">
                                        </div>
                                         <div class="form-group">
                                         ...
                                         <label>Station</label>   <input placeholder="Station"  name="station" id="station" type="text" required="" readonly="" >
                                      	<label>KM</label>	   <input placeholder="km"  name="km" id="km" type="text" required="" readonly="" >
                                        </div>
                                ...
                                <div class="col-lg-6">
								 ...
								 <div class="alert alert-warning" role="alert">
								 	 ...
								 	 <?php echo form_open('admin_staff_operation/insert_leave'); ?>
								 	 <div class="form-group">
                                            <label for="date">Leave Date</label>
                                            <input class="form-control" placeholder="Select the date" required="" onchange=""  name="date" type="date">
                                        </div>
                                         <div class="form-group">
	...
	$("#work").keyup(function(e){
		...
		jQuery.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/admin_staff_operation/getdoctor",
				dataType: 'json',
				data: { place: place 
