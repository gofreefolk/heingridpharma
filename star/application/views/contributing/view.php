...
.dock-item2 img {
 ...
 <script src="<?php echo base_url()."assets/"?>js/interface.js"></script>
  ...
  <div class="dock-container" >
	  <a class="dock-item" href="<?php echo base_url(); ?>index.php/contributing/add_doctor">
	  ...
	  <a class="dock-item" href="<?php echo base_url(); ?>index.php/contributing/view_by_year">
