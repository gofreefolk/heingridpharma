  ...
  <div class="modal-dialog" style="width: 700px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">Contributing List</h4>
      </div>
      <?php echo form_open("contributing/save_update"); ?>
      <div class="modal-body">
        
          <div class="form-group">
            <label for="dname"  class="control-label">Dr Namek</label>
             <input type="text" id="dname" required="" name="dr_name"  class="form-control" value="<?php echo $dr_name; ?>"/>
          ...
          <div class="form-group">
            <label for="product" class="control-label">Product</label>
             <input type="text" required="" id="product" name="product" class="form-control" value="<?php echo $product; ?>" id="station"/>
          </div>
          <div class="form-group">
       ...
       <input type="hidden" value="<?php echo $con_id; ?>" name="con_id" id="con_id"/>
